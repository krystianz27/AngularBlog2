...
var readline = require("readline"); // Zmiana na import całego modułu
// Konfiguracja OAuth2
...
function getAccessToken() {
    ...
    rl.question("Enter the code from that page here: ", function (code) { return __awaiter(_this, void 0, void 0, function () {
        var tokens, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error("Error retrieving access token", err_1);
                    return [3 /*break*/, 4];
